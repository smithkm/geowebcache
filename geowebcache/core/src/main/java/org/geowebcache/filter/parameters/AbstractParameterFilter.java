...
public abstract class AbstractParameterFilter implements ParameterFilter {
    ...
    /**
     * For XStream
     * @deprecated For use by XStream.
     */
    public AbstractParameterFilter() {
        // Empty for XStream
    }
     ...
     * @param defaultValue
     */
    public AbstractParameterFilter(String key, @Nullable String defaultValue) {
        setKey(key);
     ...
     * @param defaultValue
     */
    public AbstractParameterFilter(String key) {
        this(key, "");
    }
     ...
     * @param key
     *            the key to set
     * @deprecated For use by XStream.  Otherwise provide with constructor.
     */
    @Deprecated
    ...
    protected AbstractParameterFilter readResolve() {
